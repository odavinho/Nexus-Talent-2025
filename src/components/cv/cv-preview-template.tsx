             ...
             <header className="px-10 py-6 flex justify-between items-center border-b-2 border-gray-200">
                <div className="flex items-center gap-4">
                     ...
                     <div>
                        ...
                        <p className="font-headline text-[13pt] text-gray-600">
                            {data.academicTitle}
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-12 gap-x-8 p-10">
                ...
                <div id="cv-sidebar" className="col-span-4 space-y-8 bg-primary/5 p-6 rounded-lg">
                    <div>
                        ...
                        <div className="mt-4 space-y-3 text-[12pt]">
                    ...
                    {data.skills && data.skills.length > 0 && (
                        <div>
                            ...
                            <ul className="mt-4 space-y-2 text-[11pt]">
                           ...
                           <div className="mt-4 space-y-5">
                                {data.academicHistory.map((edu, index) => (
                                    <div key={index}>
                                        ...
                                        <h3 className="font-headline text-[13pt] font-bold text-gray-900 mt-1">{edu.degree}</h3>
                                        <p className="text-[12pt] font-medium text-gray-700">{edu.institution}</p>
                                    </div>
                                ))}
                           </div>
                        </section>
